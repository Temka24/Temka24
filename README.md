...
and my second SaaS Lerno - a moren English word memorizing flashcard app that to helps people more faster to learn english.
...
`Next.js`, `TypeScript`, `TailwindCSS`, `NestJS`, `PostgreSQL`, `Prisma`, `WebSocket`, `FastAPI`, `Turborepo`, `Inngest`, `Upstash`, `Monitoring`, `Analyst`, `React-Query`, `Redux ToolKit`, `Expo`, `System Design`,
